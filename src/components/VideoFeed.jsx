export default function VideoFeed({ title, src, height }) {
  return (
    <div className="bg-slate-900/60 border border-slate-800 rounded-xl overflow-hidden">
      ...
      <div className={`w-full bg-slate-950 flex items-center justify-center ${height ? '' : 'aspect-video'}`} style={height ? { height } : undefined}>
        {src ? (
