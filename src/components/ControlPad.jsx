...
export default function ControlPad() {
  ...
  return (
    <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 grid grid-cols-3 gap-2 place-items-center">
      <button
        onMouseDown={start("move_forward")}
        onMouseUp={stop}
        onTouchStart={start("move_forward")}
        onTouchEnd={stop}
        className="col-span-3 text-2xl bg-sky-600/30 hover:bg-sky-600/40 border border-sky-500/50 rounded-lg py-3 w-full"
      >
        ⬆️
      </button>
      ...
      <button
        ...
        onTouchEnd={stop}
        className="text-2xl bg-sky-600/30 hover:bg-sky-600/40 border border-sky-500/50 rounded-lg py-3 w-full"
      >
        ⬅️
      </button>
      ...
      <button
        ...
        className="text-xs bg-rose-700/80 hover:bg-rose-700 text-white border border-rose-500/60 rounded-lg py-3 w-full"
      >
        EMERGENCY STOP
      </button>
